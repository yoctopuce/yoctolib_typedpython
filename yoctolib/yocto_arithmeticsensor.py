...
if not _IS_MICROPYTHON:
    ...
    try:
        YArithmeticSensorValueCallback = Union[Callable[['YArithmeticSensor', str], Any], None]
        YArithmeticSensorTimedReportCallback = Union[Callable[['YArithmeticSensor', YMeasure], Any], None]
    except TypeError:
