...
#  $Id: svn_id $
#
#  High-level API for YGroundSpeed
#
#  - - - - - - - - - License information: - - - - - - - - -
#
...
# *********************************************************************
"""
Yoctopuce library: High-level API for YGroundSpeed
...
if not _IS_MICROPYTHON:
    ...
    try:
        YGroundSpeedValueCallback = Union[Callable[['YGroundSpeed', str], Awaitable[None]], None]
        YGroundSpeedTimedReportCallback = Union[Callable[['YGroundSpeed', YMeasure], Awaitable[None]], None]
    except TypeError:
...
class YGroundSpeed(YSensor):
    ...
    if not _IS_MICROPYTHON:
        def registerTimedReportCallback(self, callback: YGroundSpeedTimedReportCallback) -> int:
            """
