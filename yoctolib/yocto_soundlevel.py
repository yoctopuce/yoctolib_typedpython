...
#  $Id: svn_id $
#
#  High-level API for YSoundLevel
#
#  - - - - - - - - - License information: - - - - - - - - -
#
...
# *********************************************************************
"""
Yoctopuce library: High-level API for YSoundLevel
version: PATCH_WITH_VERSION
requires: yocto_soundlevel_aio
requires: yocto_api
...
from .yocto_soundlevel_aio import YSoundLevel as YSoundLevel_aio
...
class YSoundLevel(YSensor):
    ...
    def FindSoundLevel(cls, func: str) -> YSoundLevel:
        ...
        """
        return cls._proxy(cls, YSoundLevel_aio.FindSoundLevelInContext(YAPI_aio, func))
    ...
    def FindSoundLevelInContext(cls, yctx: YAPIContext, func: str) -> YSoundLevel:
        ...
        @return a YSoundLevel object allowing you to drive the sound pressure level meter.
        """
        return cls._proxy(cls, YSoundLevel_aio.FindSoundLevelInContext(yctx._aio, func))
    ...
    def FirstSoundLevel(cls) -> Union[YSoundLevel, None]:
        ...
        @return a pointer to a YSoundLevel object, corresponding to
                ...
                if there are none.
        """
        return cls._proxy(cls, YSoundLevel_aio.FirstSoundLevelInContext(YAPI_aio))
    ...
    def FirstSoundLevelInContext(cls, yctx: YAPIContext) -> Union[YSoundLevel, None]:
        ...
        @return a pointer to a YSoundLevel object, corresponding to
                ...
                if there are none.
        """
        return cls._proxy(cls, YSoundLevel_aio.FirstSoundLevelInContext(yctx._aio))
    ...
    def nextSoundLevel(self) -> Union[YSoundLevel, None]:
        ...
        """
        return self._proxy(type(self), self._aio.nextSoundLevel())
    ...
    if not _DYNAMIC_HELPERS:
        def get_label(self) -> str:
            ...
            """
            return self._run(self._aio.get_label())
    ...
    if not _IS_MICROPYTHON:
        def registerValueCallback(self, callback: YSoundLevelValueCallback) -> int:
            """
    ...
    if not _IS_MICROPYTHON:
        def registerTimedReportCallback(self, callback: YSoundLevelTimedReportCallback) -> int:
            """
