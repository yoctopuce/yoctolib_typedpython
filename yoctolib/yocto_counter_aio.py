...
#  $Id: svn_id $
#
#  Asyncio implementation of YCounter
#
#  - - - - - - - - - License information: - - - - - - - - -
#
...
# *********************************************************************
"""
Yoctopuce library: Asyncio implementation of YCounter
...
class YCounter(YSensor):
    ...
    _valueCallback: YCounterValueCallback
    _timedReportCallback: YCounterTimedReportCallback
    # --- (end of YCounter attributes declaration)

    def __init__(self, yctx: YAPIContext, func: str):
        super().__init__(yctx, 'Counter', func)
    ...
    def FindCounter(cls, func: str) -> YCounter:
        ...
        """
        return cls.FindCounterInContext(YAPI, func)
    ...
    def FindCounterInContext(cls, yctx: YAPIContext, func: str) -> YCounter:
        ...
        @return a YCounter object allowing you to drive the counter.
        """
        obj: Union[YCounter, None] = yctx._findInCache('Counter', func)
        if obj:
            return obj
        return YCounter(yctx, func)
    ...
    def FirstCounter(cls) -> Union[YCounter, None]:
        ...
        @return a pointer to a YCounter object, corresponding to
                ...
                if there are none.
        """
        return cls.FirstCounterInContext(YAPI)
    ...
    def FirstCounterInContext(cls, yctx: YAPIContext) -> Union[YCounter, None]:
        ...
        @return a pointer to a YCounter object, corresponding to
                ...
                if there are none.
        """
        hwid: Union[HwId, None] = yctx._firstHwId('Counter')
        if hwid:
            return cls.FindCounterInContext(yctx, hwid2str(hwid))
        return None
    ...
    def nextCounter(self) -> Union[YCounter, None]:
        ...
        try:
            next_hwid = self._yapi._nextHwId('Counter', self.get_hwId())
    ...
    if not _IS_MICROPYTHON:
        async def registerTimedReportCallback(self, callback: YCounterTimedReportCallback) -> int:
            """
