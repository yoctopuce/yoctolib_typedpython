...
if not _IS_MICROPYTHON:
    ...
    try:
        YWeighScaleValueCallback = Union[Callable[['YWeighScale', str], Awaitable[None]], None]
        YWeighScaleTimedReportCallback = Union[Callable[['YWeighScale', YMeasure], Awaitable[None]], None]
    except TypeError:
